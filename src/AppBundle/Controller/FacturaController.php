...
//                $factura = new Factura();
    ...
    /**
     * @Route("/{id}/editar", name="edit_factura")
     */
    ...
    /**
     * @Route("/{id}/cancelar", name="cancelada")     *
     */
