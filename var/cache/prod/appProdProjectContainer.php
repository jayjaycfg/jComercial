...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Un23ko37De', 0, (__DIR__.'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventSubscriber(new \AppBundle\Doctrine\HashPasswordListener(${($_ = isset($this->services['security.password_encoder']) ? $this->services['security.password_encoder'] : $this->get('security.password_encoder')) && false ?: '_'}));
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'jComercial', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = DoctrineORMEntityManager_00000000795498c90000000077d6dae2414a8ce94f35fcb57d712fb39ebae1f9::staticProxyConstructor(
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_092c9a3df4651890735e2a2b59e7b873593a0d350cc29a0cfc8ccda8322f960d');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Atjcb0-1ny', 0, '5ZvLXQEI2wSenIv-tsbgmK', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('iKkVuknMgb', NULL, '5ZvLXQEI2wSenIv-tsbgmK', ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ReQopPAwC-', 0, '5ZvLXQEI2wSenIv-tsbgmK', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5ae5225f8a47a9.51684289');
    }
...
class DoctrineORMEntityManager_00000000795498c90000000077d6dae2414a8ce94f35fcb57d712fb39ebae1f9 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5ae5225f9e146757732676 = null;
    private $initializer5ae5225f9e14c386806619 = null;
    private static $publicProperties5ae5225f9e12e859082009 = array(
        
    );
    public function getConnection()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getConnection', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getMetadataFactory', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getExpressionBuilder', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'beginTransaction', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getCache', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getCache();
    }
    public function transactional($func)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'transactional', array('func' => $func), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->transactional($func);
    }
    public function commit()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'commit', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->commit();
    }
    public function rollback()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'rollback', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getClassMetadata', array('className' => $className), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'createQuery', array('dql' => $dql), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'createNamedQuery', array('name' => $name), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'createQueryBuilder', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'flush', array('entity' => $entity), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->flush($entity);
    }
    public function find($entityName, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'clear', array('entityName' => $entityName), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->clear($entityName);
    }
    public function close()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'close', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->close();
    }
    public function persist($entity)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'persist', array('entity' => $entity), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'remove', array('entity' => $entity), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'refresh', array('entity' => $entity), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'detach', array('entity' => $entity), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'merge', array('entity' => $entity), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'contains', array('entity' => $entity), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getEventManager', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getConfiguration', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'isOpen', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getUnitOfWork', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getProxyFactory', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'initializeObject', array('obj' => $obj), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'getFilters', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'isFiltersStateClean', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'hasFilters', array(), $this->initializer5ae5225f9e14c386806619);
        return $this->valueHolder5ae5225f9e146757732676->hasFilters();
    }
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer5ae5225f9e14c386806619 = $initializer;
        return $instance;
    }
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        static $reflection;
        if (! $this->valueHolder5ae5225f9e146757732676) {
            $reflection = $reflection ?: new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder5ae5225f9e146757732676 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        }, $this, 'Doctrine\\ORM\\EntityManager')->__invoke($this);
        }
        $this->valueHolder5ae5225f9e146757732676->__construct($conn, $config, $eventManager);
    }
    public function & __get($name)
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, '__get', ['name' => $name], $this->initializer5ae5225f9e14c386806619);
        if (isset(self::$publicProperties5ae5225f9e12e859082009[$name])) {
            return $this->valueHolder5ae5225f9e146757732676->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ae5225f9e146757732676;
    ...
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ae5225f9e14c386806619);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ae5225f9e146757732676;
    ...
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, '__isset', array('name' => $name), $this->initializer5ae5225f9e14c386806619);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ae5225f9e146757732676;
    ...
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, '__unset', array('name' => $name), $this->initializer5ae5225f9e14c386806619);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ae5225f9e146757732676;
    ...
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, '__clone', array(), $this->initializer5ae5225f9e14c386806619);
        $this->valueHolder5ae5225f9e146757732676 = clone $this->valueHolder5ae5225f9e146757732676;
    }
    public function __sleep()
    {
        $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, '__sleep', array(), $this->initializer5ae5225f9e14c386806619);
        return array('valueHolder5ae5225f9e146757732676');
    }
    ...
    {
        $this->initializer5ae5225f9e14c386806619 = $initializer;
    }
    public function getProxyInitializer()
    {
        return $this->initializer5ae5225f9e14c386806619;
    }
    public function initializeProxy() : bool
    {
        return $this->initializer5ae5225f9e14c386806619 && $this->initializer5ae5225f9e14c386806619->__invoke($this->valueHolder5ae5225f9e146757732676, $this, 'initializeProxy', array(), $this->initializer5ae5225f9e14c386806619);
    }
    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder5ae5225f9e146757732676;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5ae5225f9e146757732676;
    }
}
